...
//        fun obtenerListaLibrosReservadas(database_ref: DatabaseReference):MutableList<LibroReservada>{
//            var lista_libro = mutableListOf<LibroReservado>()
//
//            database_ref.child("libreria")
...
//                    override fun onDataChange(snapshot: DataSnapshot) {
//                        snapshot.children.forEach{hijo : DataSnapshot ->
//                            val pojo_libro_reservada = hijo.getValue(LibroReservado::class.java)
//                            lista_libros.add(pojo_libro_reservado!!)
//                        }
//                    }
//
//                    override fun onCancelled(error: DatabaseError) {
...
//        fun escribirLibroReservado(db_ref: DatabaseReference, id: String, idlibro:String, idusuario:String, estado_c:String, estado_notificacion: Int, user_notificacion: String)=
